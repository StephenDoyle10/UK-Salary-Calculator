...
function earnings(gross) {
  ...
  if(gross>0&&gross<=12500){
    ...
    if (gross<=9500){
      ...
      return "Your gross annual pay (in other words, pay before tax) is <strong>£"+thous(gross.toFixed(2))+"</strong>."
  ...
  else if(gross<=0){return "Error. Illegible amount entered.";}
  else {return "Error. Illegible amount entered.";}
